...
import logo from "./Producthub_Header.png"
        ...
        <div>
          ...
          >
            <div
              ...
              style={{ backgroundColor: "#12517A", color: "white", height:"300px"}}
            >
              <a
                className="navbar-brand py-2 px-2"
                href="/home"
              >
      ...
      return (
        <div>
          ...
          >
            <div
              className="container-fluid"
              style={{ backgroundColor: "#12517A", color: "white", height:"60px" }}
            >
              <a
                className="navbar-brand py-2 px-2"
                href="/home"
